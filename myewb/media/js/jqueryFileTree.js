...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		fileTree: function(o, h) {
			...
			if( o.onload == undefined ) o.onload = function(c) {};
			...
			$(this).each( function() {
				...
				function showTree(c, t, s) {
					...
					$.post(o.script, { dir: t, selected: s }, function(data) {
						$(c).find('.start').html('');
					...
					$(t).find('LI A').bind(o.folderEvent, function() {
						if( $(this).parent().hasClass('directory') ) {
							if( $(this).parent().hasClass('collapsed') ) {
								...
								$(this).parent().removeClass('collapsed').addClass('expanded tree-selected-folder tree-selected');
							} else {
								// Collapse
				...
				showTree( $(this), escape(o.root), escape(o.selected) );
			});
		}
	});
