...
DATABASE_NAME = 'myewb_development'       # Or path to database file if using sqlite3.
DATABASE_USER = 'myewbuser'             # Not used with sqlite3.
DATABASE_PASSWORD = 'd0rothy'         # Not used with sqlite3.
