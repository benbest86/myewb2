...
from apply.models import Session, ApplicationQuestion, InterviewQuestion, EvaluationCriterion
from apply.forms import SessionForm, ApplicationQuestionForm, InterviewQuestionForm, EvaluationCriterionForm

@permission_required('applications.admin')
def sessions(request):
    sessions = Session.objects.all()

    return render_to_response('apply/session/list.html', {
...
def session_detail(request, object_id):
    ...
    return render_to_response('apply/session/detail.html',
                              {'session': session},
                              context_instance=RequestContext(request))
...
def session_edit(request, object_id=None):
    ...
    if request.method == 'POST':
        ...
        return render_to_response('apply/session/form.html',
                                  {'session': session,
                                   'form': form},
                                   context_instance=RequestContext(request))
    else:
        ...
        #return render_to_response('apply/session_detail.html',
        return render_to_response('apply/session/form.html',
                                  {'session': session,
                                   'form': form},
                                   context_instance=RequestContext(request))
...
def question_edit(request, object_id):
    ...
    return render_to_response('apply/question/form.html',
                              {'question': question,
                               'form': form},
                               context_instance=RequestContext(request))
