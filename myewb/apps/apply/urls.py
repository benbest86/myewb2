...
urlpatterns = patterns('apply.views',
    url(r'^$', direct_to_template, {"template": "apply/volunteering.html"}, name="volunteering_index"),
...
urlpatterns += patterns('apply.views.sessions',
...
casestudy_info = {
  ...
  'template_name': 'apply/casestudy/list.html',
  'template_object_name': 'casestudy',
  'paginate_by': 10,
}

casestudy_info_edit = {
  'template_name': 'apply/casestudy/form.html',
  'template_object_name': 'casestudy',
...
casestudy_info_new = {
  'template_name': 'apply/casestudy/form.html',
  'form_class':  CaseStudyForm,
  'post_save_redirect': '/apply/casestudys/',
}
...
### APPLICATIONS
urlpatterns += patterns('apply.views.applications',
...
### EVALUATIONS
urlpatterns += patterns('apply.views.evaluations',
...
urlpatterns += patterns('apply.views.placements',
