...
from apps.creditcard.models import Product
...
class UniFormNode(BasicNode): 
    ...
    def render(self, context):
        ...
        template = get_template('creditcard/whole_uni_form.html')        
        return template.render(c)    
...
register.inclusion_tag("creditcard/product_line.html")(get_product_info)
