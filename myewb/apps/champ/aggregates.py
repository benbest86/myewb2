...
CHAMP_AGGREGATES = {
    ...
    'pe_events': ("Number of outreach events", 414),
    ...
    'so_students': ("Students reached (youth engagement)", 26417),
    'so_presentations': ("Youth engagement presentations", 1200),
    'fundraising_dollars': ("Total fundraising dollars", 780000),
    'fundraising_dollars_oneoff': ("Fundraising from one-off events", 138000),
    'fundraising_dollars_recurring': ("Fundraising from recurring events", 95000),
    'fundraising_dollars_nonevent': ("Fundraising from non-event sources", 452000),
